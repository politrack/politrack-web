<template>
  <v-card class="quotes-card rounded-xl blur-background" rounded>
    <v-carousel
        light
        :cycle="false"
        :show-arrows="false"
      ...
      <v-carousel-item
        ...
        <div class="image-background d-flex flex-row justify-center pa-5">
          <div class="text-left px-5 pt-1 fill-height">
            ...
            <a :href="quote.article.url" target="_blank">
              <small class="grey--text text--darken-3 font-italic text-decoration-none d-inline-block">{{ quote.article.title }}</small>
            </a>
          </div>
