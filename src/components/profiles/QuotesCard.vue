<template>
  <v-carousel
      ...
      :vertical-delimiters="'yes'"
      delimiter-icon="fas fa-minus"
      :vertical="true" class="quotes-carousel" height="auto">
    <v-carousel-item
        v-for="quote in quotes"
        :key="quote.id"
        class="text-center carousel-item">
      <div class="d-flex h-100 justify-center align-center">
        <v-card class="rounded-xl blur-background opaque d-flex flex-row ma-2 pa-3" rounded>
